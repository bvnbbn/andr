...
public class English_SongsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.english_songs_list);
        mlistview = (ListView) findViewById(R.id.english_songs);

        DatabaseReference hindi = FirebaseDatabase.getInstance().getReference().child("Vikas").child("Music").child("English");
